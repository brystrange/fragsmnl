...
const Checkout = ({ reservations, products, user, logout, isAdmin, collections, createOrder }) => {
      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold ${step >= 1 ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
              1
            </div>
            <span className={`ml-2 mr-4 font-medium ${step >= 1 ? 'text-purple-600' : 'text-gray-400'}`}>Select Items</span>
          </div>
          <div className="w-12 h-0.5 bg-gray-300"></div>
          <div className="flex items-center ml-4">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold ${step >= 2 ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-600'}`}>
              2
            </div>
            <span className={`ml-2 font-medium ${step >= 2 ? 'text-purple-600' : 'text-gray-400'}`}>Shipping Details</span>
          </div>
        </div>
                  ...
                  <div className="space-y-4">
                    {reservations.map(reservation => {
                      ...
                      return (
                        <div
                          key={reservation.id}
                          className={`border rounded-lg p-4 transition ${isSelected ? 'border-purple-500 bg-purple-50' : 'border-gray-200'
                            }`}
                        >
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${useDifferentAddress ? 'bg-white' : 'bg-gray-100'
                          }`}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        disabled={!useDifferentAddress}
                        rows={3}
                        className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none ${useDifferentAddress ? 'bg-white' : 'bg-gray-100'
                          }`}
