...
import { QrCode, CreditCard, Download, Check, ArrowLeft, Copy, Upload, MapPin, User, Phone, Mail, Image, CheckCircle, Clock, AlertCircle, XCircle } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="font-bold text-gray-900 text-xl">Order #{order.orderNumber}</h3>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              {/* Decline Alert - Always visible when declined */}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mb-2">
                        <div className="flex items-center justify-between text-xs mb-1">
                          <span className="font-medium text-red-900">Upload Attempts</span>
                          <span className="text-red-700">
                            {order.currentAttempt || 0} of 3 attempts used
                          </span>
                        </div>
                        <div className="w-full bg-red-100 rounded-full h-2 overflow-hidden">
                          <div 
                            className="h-full bg-red-600 transition-all duration-300"
                            style={{ width: `${((order.currentAttempt || 0) / 3) * 100}%` }}
                          />
                        </div>
                        <p className="text-xs text-red-600 mt-1">
                          {3 - (order.currentAttempt || 0)} attempts remaining before order cancellation
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {order.paymentProofUrl ? (
                <div className="space-y-4">
                  ...
                  {/* Re-upload button when declined */}
                  {order.paymentStatus === 'declined' && (order.currentAttempt || 0) < 3 && (
                    <div className="pt-4 border-t">
                      <p className="text-sm font-medium text-gray-900 mb-3">Upload a new payment proof</p>
                      ...
                      >
                        {uploading ? (
                          ...
                          <>
                            ...
                            <span className="font-medium text-purple-600">Click to re-upload payment proof</span>
                      ...
                      {uploadError && (
                        <div className="p-3 bg-red-50 text-red-700 rounded-lg text-sm mt-3">
                          {uploadError}
                        </div>
                      )}
                    </div>
                  ...
                  {order.paymentStatus === 'declined' && (order.currentAttempt || 0) >= 3 && (
                    <div className="p-4 bg-red-100 border border-red-300 rounded-lg">
                      <p className="text-sm text-red-900 font-semibold">
                        Maximum upload attempts reached. Your order will be cancelled.
                      </p>
                    </div>
                  )}
                </div>
