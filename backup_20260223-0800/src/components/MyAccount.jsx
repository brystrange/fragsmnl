    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-2xl mx-auto p-6">
                ...
                {/* Profile Card */}
                <div className="bg-white rounded-lg shadow-md overflow-hidden text-[14px]">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-accent-700 to-accent-800 px-6 py-8 text-center">
                        <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
                            <User className="w-10 h-10 text-accent-700" />
                        </div>
