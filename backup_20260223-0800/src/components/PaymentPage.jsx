...
const PaymentPage = ({ orders, paymentSettings, user, logout, isAdmin, collections, reservations, updateOrderPaymentProof, notifications, markNotificationRead, markAllNotificationsRead, invoiceSettings, timeSettings }) => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case 'pending':
        return (
          <span className="inline-flex items-center gap-1 px-4 py-1 bg-yellow-100 text-yellow-800 text-[13px] font-medium rounded-lg">
      ...
      case 'payment_submitted':
        return (
          <span className="inline-flex items-center gap-1 px-4 py-1 bg-blue-100 text-blue-800 text-[13px] font-medium rounded-lg">
      ...
      case 'verified':
        return (
          <span className="inline-flex items-center gap-1 px-4 py-1 bg-green-100 text-green-800 text-[13px] font-medium rounded-lg">
      ...
      case 'declined':
        return (
          <span className="inline-flex items-center gap-1 px-4 py-1 bg-red-100 text-red-800 text-[13px] font-medium rounded-lg">
      ...
      default:
        return (
          <span className="inline-block px-4 py-1 bg-gray-100 text-gray-800 text-[13px] font-medium rounded-lg">
            {status}
          </span>
        );
    }
      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-m font-bold text-green-900 mb-2">Order Created Successfully!</h2>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex flex-col items-end gap-2">
                  ...
                  <button
                    ...
                    className="text-[13px] text-accent-700 hover:text-accent-800 flex items-center gap-1 bg-accent-100 hover:bg-slate-100 px-4 py-1 rounded-lg"
                  >
