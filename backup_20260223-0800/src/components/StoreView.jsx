...
const StoreView = ({ collections, products, user, reserveProduct, logout, reservations, isAdmin, notifications, markNotificationRead, markAllNotificationsRead }) => {
                  ...
                  <div className="p-4">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-lg font-bold text-gray-900">₱{product.price.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
