                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                    <div className="flex items-center justify-between">
                        ...
                        <select
                            ...
                            className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600 focus:outline-none text-sm bg-white"
                        >
                                        ...
                                        {order.paymentStatus === 'cancelled' && order.cancellationReason && (
                                            <div className="mt-4 p-4 bg-red-50 border-2 border-red-300 rounded-lg">
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div className="flex-1">
                                                        <h4 className="font-semibold text-red-900 mb-1" style={{ fontSize: '14px' }}>Order Cancelled</h4>
                                                ...
                                                {order.paymentProofUrl && (
                                                    <div className="bg-white p-4 rounded-lg">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex items-center gap-2 text-accent-700 hover:text-accent-800 font-medium text-sm"
                                                        >
