    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <button
          ...
          className="flex items-center gap-2 text-[14px] text-gray-600 hover:text-gray-900 mb-6"
        >
        ...
        {/* Step Indicator */}
        <div className="flex items-center justify-center mb-8 text-[14px]">
          <div className="flex items-center">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold ${step >= 1 ? 'bg-accent-700 text-white' : 'bg-gray-200 text-gray-600'}`}>
              1
            </div>
            <span className={`ml-2 mr-4 font-medium ${step >= 1 ? 'text-accent-700' : 'text-gray-400'}`}>Select Items</span>
          </div>
          <div className="w-12 h-0.5 bg-gray-300"></div>
          <div className="flex items-center ml-4">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold ${step >= 2 ? 'bg-accent-700 text-white' : 'bg-gray-200 text-gray-600'}`}>
              2
            </div>
            <span className={`ml-2 font-medium ${step >= 2 ? 'text-accent-700' : 'text-gray-400'}`}>Shipping Details</span>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              {step === 1 ? (
                ...
                <div className="bg-white rounded-lg shadow p-6 text-[14px]">
                ...
                {step === 1 ? (
                  <button
                    ...
                    className={`w-full py-3 rounded-lg font-semibold transition flex items-center justify-center gap-2 ${selectedCount > 0
                      ? 'btn-accent'
                      : 'bg-gray-200 text-[14px] text-gray-500 border border-gray cursor-not-allowed'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-lg font-semibold transition ${selectedCount > 0 && !isSubmitting
                      ? 'bg-green-600 text-[14px] text-white hover:bg-green-700'
                      : 'bg-gray-200 text-[14px] text-gray-500 cursor-not-allowed'
                      }`}
                  >
