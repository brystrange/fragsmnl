...
const AdminOnboarding = ({ onAdminCreated, showToast }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent-950 via-accent-950 to-pink-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-lg font-bold text-white mb-2">Admin Onboarding Form</h1>
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          {mode === 'verify' ? (
            ...
            <form onSubmit={handleVerifyAccessCode} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-[14px] border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600 focus:border-transparent"
              ...
              <div className="text-center">
                <a
                  href="/login"
                  className="text-[13px] text-accent-700 hover:text-accent-800 font-medium"
                >
            ...
            <form onSubmit={handleCreateAdmin} className="space-y-4 text-[13px]">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600 focus:border-transparent"
                    required
                  />
                </div>
                <div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <p className="text-[12px] text-green-800 flex items-center gap-2">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={handleBack}
                  className="flex-1 px-2 py-3 border border-gray-300 text-[14px] rounded-lg hover:bg-gray-50 transition font-semibold"
                  disabled={loading}
                >
                  Back
                </button>
