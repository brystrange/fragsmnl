    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          ...
          <h1 className="text-lg font-bold text-center mb-2 text-gray-800">Almost There!</h1>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-slate-600 text-white py-3 rounded-lg font-semibold hover:bg-slate-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <h1 className="text-lg font-bold text-center mb-2 text-gray-800">Mine Shop</h1>
        <p className="text-center text-gray-600 mb-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-slate-600 text-white py-3 rounded-lg font-semibold hover:bg-slate-700 transition disabled:opacity-50 disabled:cursor-not-allowed mt-2"
          >
