...
const PaymentPage = ({ orders, paymentSettings, user, logout, isAdmin, collections, reservations, updateOrderPaymentProof, notifications, markNotificationRead, markAllNotificationsRead }) => {
