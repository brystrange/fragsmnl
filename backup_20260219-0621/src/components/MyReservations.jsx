...
import { Clock, Trash2, ShoppingBag, X, AlertCircle } from 'lucide-react';
        ...
        {reservations.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-slate-600 text-white rounded-lg hover:bg-slate-700 transition font-semibold"
            >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center gap-4 mb-3">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-semibold text-gray-900">{reservation.quantity || 1}</span>
                                  </div>
              ...
              <div className="pt-2">
                <button
                  onClick={() => navigate('/store')}
                  className="text-slate-600 hover:text-slate-700 font-medium text-sm flex items-center gap-2"
                >
                  ← Continue Shopping
                </button>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-slate-600 text-white rounded-lg hover:bg-slate-700 active:bg-slate-800 transition font-semibold text-lg shadow-lg hover:shadow-xl"
                >
                  <ShoppingBag className="w-5 h-5" />
                  Proceed to Checkout
                </button>
