      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onSave}
            disabled={isSaving}
            className="flex-1 btn-accent px-4 py-2 text-sm font-semibold flex items-center justify-center gap-2 disabled:opacity-70"
          >
            {isSaving ? (
      ...
      <form onSubmit={handlePaymentSubmit} className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="url" name="qrCodeUrl" value={formData.qrCodeUrl} onChange={handleQrCodeChange}
                ...
                className="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600 focus:border-transparent transition" />
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <button type="submit" disabled={savingPayments}
            className="flex items-center gap-2 btn-accent px-6 py-2.5">
            {savingPayments ? (
              <><Loader2 className="w-4 h-4 animate-spin" /> Saving…</>
            ) : (
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea name="termsAndConditions" value={invoiceFormData.termsAndConditions} onChange={handleInvoiceChange}
                ...
                className="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600 focus:border-transparent transition resize-y" />
            </div>
            <div>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-5 py-3 text-left transition-all text-sm group ${isActive
                  ? 'bg-slate-50 text-accent-800 border-r-2 border-accent-700 font-semibold'
                  : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                  }`}
              >
                <Icon className={`w-4 h-4 flex-shrink-0 ${isActive ? 'text-accent-700' : 'text-gray-400 group-hover:text-gray-600'}`} />
