          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-accent-700">₱{totalRevenue.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
              </div>
            ...
            <div className="flex-1 min-w-[250px]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600"
                />
              </div>
            </div>
            <select
              ...
              className="px-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600"
            >
                  ...
                  filteredOrders.map(order => {
                    ...
                    return (
                      <tr key={order.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm font-semibold text-accent-700">₱{order.totalAmount.toLocaleString('en-PH')}</td>
                        <td className="px-4 py-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            {order.paymentStatus === 'payment_submitted' && verifyOrderPayment && (
                              <button
                                ...
                                className="p-2 text-accent-700 hover:bg-slate-50 rounded"
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(0, 0, 0, 0.85)' }}>
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6">
                          ...
                          <div className={`p-3 rounded-lg border ${bgColor} ${isLatest ? 'ring-1 ring-offset-1 ring-gray-300' : ''}`}>
                            <div className="flex items-center justify-between mb-1.5">
                              ...
                              <button
                                ...
                                className="text-xs text-accent-700 hover:text-accent-900 font-medium underline"
                              >
                                View Proof
                              </button>
                            </div>
                ...
                <div className="border rounded-lg divide-y">
                  {selectedOrder.items.map((item, i) => (
                    <div key={i} className="p-3 flex justify-between">
                      ...
                      <div className="font-semibold text-accent-700 pl-4 whitespace-nowrap">₱{item.totalPrice.toFixed(2)}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="border-t pt-4 flex justify-between mb-6">
                ...
                <span className="font-bold text-accent-700 text-lg">₱{selectedOrder.totalAmount.toLocaleString('en-PH', { minimumFractionDigits: 2 })}</span>
              </div>
              ...
              <div className="flex flex-wrap gap-2 border-t pt-4">
                <button onClick={() => downloadInvoice(selectedOrder)} className="btn-accent flex items-center justify-center gap-2">
                  <Download className="w-4 h-4" />
                  Download Invoice
                </button>
