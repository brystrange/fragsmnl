...
const StoreNavbar = ({
    ...
    return (
        <>
            ...
            {isAdmin && (
                <div className="bg-red-50 border-b-2 border-red-400 px-3 sm:px-4 py-2">
                    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
                            <span className="text-red-700 font-semibold text-xs sm:text-sm">Preview Mode</span>
                            <span className="text-red-600 text-xs sm:text-sm hidden sm:inline">— You are viewing the store as customers see it</span>
                        </div>
                        <button
                            onClick={() => navigate('/admin')}
                            className="flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition text-xs sm:text-sm font-medium"
                        >
            ...
            <nav className="bg-white shadow-sm border-b sticky top-0 z-40">
                <div className="max-w-7xl mx-auto px-2 sm:px-4 h-14 sm:h-16">
                    <div className="flex items-center justify-between gap-2 sm:gap-4 h-full">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <ShoppingBag className="w-5 h-5 sm:w-6 sm:h-6 text-accent-700" />
                                <h1 className="text-sm sm:text-base font-bold text-gray-800 truncate max-w-[120px] sm:max-w-none">
                                    {pageTitle || 'FRAGS.mnl'}
                                </h1>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1 sm:gap-3">
                            ...
                            <button
                                ...
                                className="relative flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 hover:bg-green-50 rounded-lg transition"
                            >
                                ...
                                {userReservations.length > 0 && (
                                    <span className="absolute -top-1 -right-1 bg-green-600 text-white text-[10px] sm:text-xs font-bold rounded-full w-3.5 h-3.5 sm:w-5 sm:h-5 flex items-center justify-center">
                            ...
                            <div className="relative" ref={notifRef}>
                                ...
                                >
                                    ...
                                    {unreadCount > 0 && (
                                        <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] sm:text-xs font-bold rounded-full w-3.5 h-3.5 sm:w-5 sm:h-5 flex items-center justify-center">
                                ...
                                {showNotifications && (
                                    <div className="fixed sm:absolute top-14 sm:top-full right-2 sm:right-0 sm:mt-2 w-[calc(100vw-1rem)] sm:w-96 max-w-sm bg-white rounded-lg shadow-xl border border-gray-200 z-50 overflow-hidden">
                                        {/* Header */}
                            ...
                            <div className="relative" ref={dropdownRef}>
                                <button
                                    ...
                                    className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 hover:bg-gray-100 rounded-lg transition"
                                >
                                    <div className="w-7 h-7 sm:w-8 sm:h-8 bg-slate-100 rounded-full flex items-center justify-center">
                                        <User className="w-4 h-4 sm:w-5 sm:h-5 text-accent-700" />
                                    </div>
                                ...
                                {showUserDropdown && (
                                    <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                                        ...
                                        <button
                                            ...
                                            className="w-full text-left px-4 py-2.5 hover:bg-stone-100 transition flex items-center gap-3 text-gray-700 text-[13px]"
                                        >
                                        ...
                                        <div className="border-t border-gray-100 mt-1 pt-1">
                                            <button
                                                ...
                                                className="w-full text-left px-4 py-2.5 hover:bg-red-50 transition flex items-center gap-3 text-red-600 text-[13px]"
                                            >
