...
const AdminPanel = ({
  ...
  return (
    <div className="admin-scroll-wrapper">
      <div className="min-h-screen bg-gray-50 admin-desktop-layout">
        {/* Header */}
        ...
        <div className="max-w-[98%] mx-auto p-6">
          ...
          {((activeMainTab === 'products' && (dataLoading?.collections || dataLoading?.products)) ||
            (activeMainTab === 'reservations' && dataLoading?.reservations) ||
            (activeMainTab === 'orders' && dataLoading?.orders) ||
            (activeMainTab === 'settings' && (dataLoading?.paymentSettings || dataLoading?.timeSettings || dataLoading?.invoiceSettings))) ? (
