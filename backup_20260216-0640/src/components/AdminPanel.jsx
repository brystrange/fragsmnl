    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-[98%] mx-auto px-6">
          <div className="flex gap-6">
            <button
              ...
              className={`px-4 py-3 font-semibold transition border-b-2 ${activeMainTab === 'products'
            ...
            <button
              ...
              className={`px-4 py-3 font-semibold transition border-b-2 ${activeMainTab === 'reservations'
                ? 'text-purple-600 border-purple-600'
                : 'text-gray-600 border-transparent hover:text-gray-900'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-3 font-semibold transition border-b-2 ${activeMainTab === 'orders'
                ? 'text-purple-600 border-purple-600'
                : 'text-gray-600 border-transparent hover:text-gray-900'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-3 font-semibold transition border-b-2 ${activeMainTab === 'settings'
                ? 'text-purple-600 border-purple-600'
                : 'text-gray-600 border-transparent hover:text-gray-900'
                }`}
            >
      ...
      <div className="max-w-[98%] mx-auto p-6">
            ...
            <div className="mb-6 flex items-center justify-between">
              <div className="flex gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition ${activeTab === 'published'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition ${activeTab === 'scheduled'
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition ${activeTab === 'draft'
                      ...
                      <div className="p-4 flex items-center justify-between hover:bg-gray-50 transition">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="p-2 text-purple-600 hover:bg-purple-100 rounded transition group relative">
                            <Plus className="w-4 h-4" />
        ...
        {activeMainTab === 'orders' && (
          <OrderManagement orders={orders} showToast={showToast} verifyOrderPayment={verifyOrderPayment} declineOrderPayment={declineOrderPayment} updateOrderTracking={updateOrderTracking} />
        )}
