                ...
                <div className={order.paymentProofUrl ? 'pt-4 border-t' : ''}>
                  ...
                  {previewImage ? (
                    <div className="space-y-4">
                      <div className="relative border-2 border-purple-200 rounded-xl p-4 bg-purple-50/30">
                        <div className="flex items-center gap-2 mb-3">
                          <Eye className="w-4 h-4 text-purple-600" />
                          <span className="text-sm font-semibold text-purple-800">Preview — Review before submitting</span>
                        </div>
                      ...
                      <button
                        ...
                        disabled={uploading}
                        className={`w-full py-3.5 rounded-xl font-semibold text-white flex items-center justify-center gap-2.5 transition-all duration-200 shadow-md ${
                          uploading
                            ? 'bg-gray-400 cursor-wait'
                            : 'bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 hover:shadow-lg active:scale-[0.98]'
                        }`}
                      >
                        {uploading ? (
                          <>
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full py-5 border-2 border-dashed rounded-xl transition-all duration-200 flex flex-col items-center gap-2 border-purple-300 hover:border-purple-500 hover:bg-purple-50 cursor-pointer group"
                      >
