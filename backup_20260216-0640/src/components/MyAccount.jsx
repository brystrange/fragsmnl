                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={!isEditing}
                                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${isEditing ? 'bg-white' : 'bg-gray-50'
                                        }`}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    disabled={!isEditing}
                                    rows={3}
                                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none ${isEditing ? 'bg-white' : 'bg-gray-50'
                                        }`}
