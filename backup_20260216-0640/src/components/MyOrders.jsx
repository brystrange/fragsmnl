                                                                ...
                                                                <div className={`p-2.5 rounded-lg border ${bgColor} ${isLatest ? 'ring-1 ring-offset-1 ring-gray-300' : ''}`}>
                                                                    <div className="flex items-center justify-between mb-1">
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            className="text-purple-600 hover:text-purple-800 text-[10px] underline font-medium"
                                                                        >
                                                                            View
                                                                        </button>
                                                                    </div>
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        {previewImage && previewOrderId === order.id ? (
                                                            <div className="space-y-3">
                                                                <div className="relative border border-purple-200 rounded-lg p-3 bg-purple-50/30">
                                                                    <div className="flex items-center gap-1.5 mb-2">
                                                                        <Eye className="w-3.5 h-3.5 text-purple-600" />
                                                                        <span className="text-xs font-semibold text-purple-800">Preview</span>
                                                                    </div>
                                                            ...
                                                            <>
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="flex items-center gap-2 px-4 py-2 border-2 border-dashed border-purple-300 text-purple-700 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition text-sm font-medium"
                                                                >
