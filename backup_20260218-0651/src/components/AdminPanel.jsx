            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium bg-slate-600 text-white rounded-lg hover:bg-slate-700 transition"
                >
                      ...
                      <div className="p-4 flex items-center justify-between hover:bg-gray-50 transition">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="p-2 text-slate-600 hover:bg-slate-100 rounded transition group relative">
                            <Plus className="w-4 h-4" />
                        ...
                        collectionProducts.length > 0 ? (
                          ...
                          <div className="border-t border-gray-200 bg-gray-50 p-8 text-center">
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-2 px-4 py-2 bg-slate-600 text-white rounded-lg hover:bg-slate-700 transition"
                            >
                              <Plus className="w-4 h-4" />
                              Add First Product
                            </button>
