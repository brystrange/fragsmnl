...
const MyAccount = ({ user, updateUserProfile, logout, isAdmin, collections, reservations, showToast }) => {
            ...
            <div className="max-w-2xl mx-auto p-6">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-slate-600 to-slate-700 px-6 py-8 text-center">
                        ...
                        <p className="text-slate-200 mt-1">{formData.email}</p>
                    </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={!isEditing}
                                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent ${isEditing ? 'bg-white' : 'bg-gray-50'
                                        }`}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    disabled={!isEditing}
                                    rows={3}
                                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent resize-none ${isEditing ? 'bg-white' : 'bg-gray-50'
                                        }`}
