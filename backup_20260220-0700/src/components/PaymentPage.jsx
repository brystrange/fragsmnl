      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-bold text-green-900 mb-2">Order Created Successfully!</h2>
                    ...
                    <div className="space-y-4">
                      <div className="relative border-2 border-slate-200 rounded-xl p-4 bg-slate-50/30">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-sm font-semibold text-slate-800">Preview — Review before submitting</span>
                        </div>
                      ...
                      <button
                        ...
                        className={`w-full py-3.5 rounded-xl font-semibold text-white flex items-center justify-center gap-2.5 transition-all duration-200 shadow-md ${uploading
                          ...
                          : 'bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 hover:shadow-lg active:scale-[0.98]'
                          }`}
                      >
                        {uploading ? (
                          <>
            ...
            <div className="bg-white rounded-lg shadow p-6 sticky top-6">
              ...
              {paymentSettings?.payMayaNumber && (
                <div className="mb-4 p-3 bg-slate-50 rounded-lg">
                  <p className="text-sm font-semibold text-slate-700 mb-1">PayMaya / Maya</p>
                  <div className="flex items-center gap-2">
