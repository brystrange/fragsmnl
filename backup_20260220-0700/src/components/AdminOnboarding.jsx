    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-slate-900 to-pink-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-lg font-bold text-white mb-2">Admin Access</h1>
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
          {mode === 'verify' ? (
            ...
            <form onSubmit={handleVerifyAccessCode} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-slate-600 to-pink-600 text-white py-3 rounded-lg font-semibold hover:from-slate-700 hover:to-pink-700 transition shadow-lg"
              >
                Verify Access Code
              </button>
            ...
            <form onSubmit={handleCreateAdmin} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-slate-600 to-pink-600 text-white rounded-lg font-semibold hover:from-slate-700 hover:to-pink-700 transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
