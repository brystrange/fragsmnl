                                        ...
                                        <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                                            ...
                                            <div className="max-h-80 overflow-y-auto">
                                                <button
                                                    ...
                                                    className={`w-full text-left px-4 py-2.5 hover:bg-purple-50 transition flex items-center gap-2 ${!filters?.collection ? 'text-purple-600 bg-purple-50' : 'text-gray-700'}`}
                                                >
                                                ...
                                                {publishedCollections.map(col => (
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-4 py-2.5 hover:bg-purple-50 transition flex items-center gap-2 ${filters?.collection === col.id ? 'text-purple-600 bg-purple-50' : 'text-gray-700'}`}
                                                    >
                                                        {col.imageUrl ? (
                                ...
                                <div className="relative">
                                    ...
                                    {setShowAdvancedSearch && (
                                        <button
                                            ...
                                            className={`absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 rounded-md transition ${showAdvancedSearch ? 'bg-purple-100 text-purple-600' : 'hover:bg-gray-100 text-gray-500'
                                                }`}
                                        >
                                ...
                                {showUserDropdown && (
                                    <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                                        ...
                                        <button
                                            ...
                                            className="w-full text-left px-4 py-2 border-b border-gray-100 hover:bg-purple-50 transition cursor-pointer"
                                        >
                                            <p className="text-sm font-medium text-gray-800 hover:text-purple-600">{user?.name || 'User'}</p>
                                        ...
                                        <button
                                            ...
                                            className="w-full text-left px-4 py-2.5 hover:bg-green-50 transition flex items-center gap-3 text-green-700"
                                        >
                                            <ShoppingBag className="w-4 h-4" />
                                            Checkout
                                        </button>
